...
| **Solver Dinâmico (JSON I/O)** | Ingestão de JSON real (FormularioHorario) em runtime | `Quadro3` + `FastSpec` | 0 penalidades | **540 penalidades** — idêntico à fitness do Rust para a mesma grade; o que falta é qualidade de busca |
